...
def main():
    ...
    # Define validation scripts to run
        validation_scripts = [
            ...
            # Hierarchy scripts (ALL 4) ✅
            ('gonfanolier/src/hierarchy/molecular_hierarchy.py', 'Molecular Hierarchy Navigation'),
            ('gonfanolier/src/hierarchy/semantic_amplification.py', 'Semantic Distance Amplification'),
            ('gonfanolier/src/hierarchy/s_entropy_coordinate_transform.py', 'S-Entropy Coordinate Transformation'),
            ('gonfanolier/src/hierarchy/empty_dictionary.py', 'Empty Dictionary Synthesis'),
