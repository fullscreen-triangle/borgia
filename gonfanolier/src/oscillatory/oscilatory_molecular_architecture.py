...
def main():
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(results_dir, 'oscillatory_architecture.png'), dpi=300)
    plt.show()
    ...
    with open(os.path.join(results_dir, 'oscillatory_architecture_results.json'), 'w') as f:
