...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=\textwidth]{panel_01_base_key.png}
\caption{\textbf{The base cut key occupies a small, unevenly populated discrete
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=\textwidth]{panel_03_orbits.png}
\caption{\textbf{Refinement recovers the automorphism orbit partition exactly.}
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=\textwidth]{panel_02_refinement.png}
\caption{\textbf{Refinement saturates quickly and lifts the class count without
...
\caption{\textbf{The negative control: breaking ties by atom index destroys the
...
\begin{figure*}[!htbp]
\centering
\includegraphics[width=\textwidth]{panel_05_classes.png}
\caption{\textbf{Class structure of the stable partition.} (\textbf{A})~Atoms per
