...
gives relational energy $319.358567$ and the explicit sum over all pairs
gives $319.358567$, an absolute residual of $0$ and a relative residual
...
%% ---- measured figures -------------------------------
\input{figures/generator-captions}
...
\Cref{rem:rngartefact}. The only stochastic component is the frequency
